...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "app_blog", function() { return AppBlog; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "events_a", function() { return EventsA; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "footer_a", function() { return FooterA; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "menu_item", function() { return MyHeader; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "my_component", function() { return MyComponent; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "my_header", function() { return MyHeader$1; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "new_listiner", function() { return NewListiner; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "new_post", function() { return NewPost; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "new_single_post", function() { return NewSinglePost$2; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "news_a", function() { return NewsA; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "popular_resources", function() { return PopularResources; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "popular_resources_aside", function() { return PopularResourcesAside; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "popular_resources_banner", function() { return PopularResourcesBanner; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "s_abdullakh_footer_icon_block", function() { return FooterA$1; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "s_abdullakh_footer_icons", function() { return FooterA$2; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "s_abdullakh_listiner", function() { return NewListiner$1; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "sidebar_a", function() { return SidebarA; });
...
const NewSinglePost = (props) => {
    return props.arr.map((item) => {
        return (Object(_index_051815ee_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: bootstrapClass(item.block) }, Object(_index_051815ee_js__WEBPACK_IMPORTED_MODULE_0__["h"])("new-single-post", { arr: item })));
    });
};
/*
...
const MyComponent = class {
    ...
    render() {
        return (Object(_index_051815ee_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", null, Object(_index_051815ee_js__WEBPACK_IMPORTED_MODULE_0__["h"])("my-header", { menu: header.menu, logoUrl: header.logoUrl, subscribeText: header.subscribeText, theme: this.theme, onClickOnTheme: () => this.clickOnTheme(), onClickOnHeader: (event) => this.clickOnHeader(event), onClickOnSwitchTheme: (event) => this.clickOnSwitchTheme(event) }), Object(_index_051815ee_js__WEBPACK_IMPORTED_MODULE_0__["h"])("news-a", { newsImg: firstPage.newsImg, news: firstPage.news, sidebar: firstPage.sidebar, onClickOnNews: (event) => this.clickOnNews(event) }), Object(_index_051815ee_js__WEBPACK_IMPORTED_MODULE_0__["h"])("new-post", { newPostTitle: firstPage.newPostTitle, newPost: firstPage.newPost, onClickNewPost: (event) => this.clickOnNewPost(event) }), Object(_index_051815ee_js__WEBPACK_IMPORTED_MODULE_0__["h"])("popular-resources", { popularAsideTitle: firstPage.popularAsideTitle, popularAside: firstPage.popularAside, popularBanner: firstPage.popularBanner, onClickOnPopular: (event) => this.clickOnPopular(event) }), Object(_index_051815ee_js__WEBPACK_IMPORTED_MODULE_0__["h"])("events-a", { eventsTitle: firstPage.eventsTitle, events: firstPage.events, onClickOnEvents: (event) => this.clickOnEvents(event) }), Object(_index_051815ee_js__WEBPACK_IMPORTED_MODULE_0__["h"])("new-listiner", { newlistner: firstPage.newlistner, onClickOnListiner: (event) => this.clickOnListiner(event) }), Object(_index_051815ee_js__WEBPACK_IMPORTED_MODULE_0__["h"])("app-blog", { p: blog.p }), Object(_index_051815ee_js__WEBPACK_IMPORTED_MODULE_0__["h"])("footer-a", { footer: footer, onClickOnFooter: (event) => this.clickOnFooter(event) })));
    }
    /**
...
const ItemLink = (props) => {
    return props.arr.map((item) => {
        return (Object(_index_051815ee_js__WEBPACK_IMPORTED_MODULE_0__["h"])("menu-item", { arr: item }));
    });
};
...
const NewSinglePost$1 = (props) => {
    return props.arr.map((item) => {
        return (Object(_index_051815ee_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: bootstrapClass$1(item.block) }, Object(_index_051815ee_js__WEBPACK_IMPORTED_MODULE_0__["h"])("new-single-post", { arr: item })));
    });
};
/*
* функция для присваивания класса бутстрап
...
const Sidebar = (props) => {
    return props.arr.map((item) => {
        return (Object(_index_051815ee_js__WEBPACK_IMPORTED_MODULE_0__["h"])("sidebar-a", { arr: item }));
    });
};
...
const PopularAside = (props) => {
    return props.arr.map((item) => {
        return (Object(_index_051815ee_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "col-12 mb-2" }, Object(_index_051815ee_js__WEBPACK_IMPORTED_MODULE_0__["h"])("popular-resources-aside", { arr: item })));
    });
};
/*
* компонентная функция для вывода элементов news-main-block
...
const PopularBanner = (props) => {
    return props.arr.map((item) => {
        return (Object(_index_051815ee_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "col-12 mb-2" }, Object(_index_051815ee_js__WEBPACK_IMPORTED_MODULE_0__["h"])("popular-resources-banner", { arr: item })));
    });
};
...
const SAbdullakhNewsMainBlock = class {
    ...
    render() {
        return (Object(_index_051815ee_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", null, Object(_index_051815ee_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "category_blog", onClick: () => this.clickOnNews.emit() }, this.arr.category), Object(_index_051815ee_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "news_section_title_block", onClick: () => this.clickOnNews.emit() }, this.arr.title), Object(_index_051815ee_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "news_section_subtitle_block", onClick: () => this.clickOnNews.emit(event) }, this.arr.subtitle, "."), Object(_index_051815ee_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "text-center text-lg-left" }, Object(_index_051815ee_js__WEBPACK_IMPORTED_MODULE_0__["h"])("button", { class: "my_btn new_section_btn", onClick: () => this.clickOnNews.emit() }, this.arr.btnText))));
    }
};
...
//# sourceMappingURL=stencil-app-blog_20-entry-js-es2015.js.map